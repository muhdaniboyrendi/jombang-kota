    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 mb-3 justify-content-center">
                ...
                <div class="{{ auth()->user()->is_admin === 1 ? 'col-lg-3 col-6' : 'col-md-4 col-6' }}">
                    <div class="app-card app-card-stat shadow-sm h-100">
                        <div class="app-card-body p-3 p-lg-4">
                            <h4 class="stats-type mb-1">Total Generus</h4>
                            <div class="stats-figure">{{ $totalGenerus }}</div>
                ...
                <div class="{{ auth()->user()->is_admin === 1 ? 'col-lg-3 col-6' : 'col-md-4 col-6' }}">
                    <div class="app-card app-card-stat shadow-sm h-100">
                        <div class="app-card-body p-3 p-lg-4">
                            ...
                            <div class="stats-figure">{{ $totalMt }}</div>
                            <div class="stats-meta text-success">
                ...
                <div class="{{ auth()->user()->is_admin === 1 ? 'col-lg-3 col-6' : 'col-md-4 col-6' }}">
                    <div class="app-card app-card-stat shadow-sm h-100">
                        <div class="app-card-body p-3 p-lg-4">
                            ...
                            <div class="stats-figure">{{ $totalMs }}</div>
                            <div class="stats-meta text-success">
                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-auto">
                                    <div class="card-header-action">
                                        <a href="" data-bs-toggle="modal" data-bs-target="#allGenerusModal">View All</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>17 Kelompok</td>
                                            <td class="stat-cell">{{ $totalGenerusLakiLaki }}</td>
                                            <td class="stat-cell">{{ $totalGenerusPerempuan }}</td>
                                            <td class="stat-cell">{{ $totalGenerus }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="app-card app-card-stats-table h-100 shadow-sm">
                        <div class="app-card-header p-3">
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-auto">
                                    <div class="card-header-action">
                                        <a href="" data-bs-toggle="modal" data-bs-target="#allMsModal">View All</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>17 Kelompok</td>
                                            <td class="stat-cell">{{ $totalMsLakiLaki }}</td>
                                            <td class="stat-cell">{{ $totalMsPerempuan }}</td>
                                            <td class="stat-cell">{{ $totalMs }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="app-card-header p-3 border-bottom-0">
                            <div class="row align-items-center gx-3">
                                ...
                                <div class="d-grid gap-2 mt-3">
                                    <a class="btn app-btn-primary" href="/generus-tambah">Tambah Generus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                        <div class="app-card-header p-3 border-bottom-0">
                            <div class="row align-items-center gx-3">
                                ...
                                <div class="d-grid gap-2 mt-3">
                                    <a class="btn app-btn-primary" href="/mt-tambah">Tambah MT</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                        <div class="app-card-header p-3 border-bottom-0">
                            <div class="row align-items-center gx-3">
                                ...
                                <div class="d-grid gap-2 mt-3">
                                    <a class="btn app-btn-primary" href="/ms-tambah">Tambah MS</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                        <div class="app-card-header p-3 border-bottom-0">
                            <div class="row align-items-center gx-3">
                                ...
                                <div class="d-grid gap-2 mt-3">
                                    <a class="btn app-btn-primary" href="/acara">Tambah Acara</a>
                                </div>
                            </div>
                        </div>
                    </div>
